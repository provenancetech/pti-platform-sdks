...
export type OneOfExternalPaymentMethod = PTI.OneOfExternalPaymentMethod.Ach | PTI.OneOfExternalPaymentMethod.CreditCard | PTI.OneOfExternalPaymentMethod.Wire | PTI.OneOfExternalPaymentMethod.Crypto;
