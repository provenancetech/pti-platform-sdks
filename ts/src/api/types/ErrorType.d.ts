...
export declare const ErrorType: {
    ...
    readonly InvalidTransactionType: "INVALID_TRANSACTION_TYPE";
    readonly InvalidTransactionStatus: "INVALID_TRANSACTION_STATUS";
    ...
    readonly ManualBankAccountNotAllowed: "MANUAL_BANK_ACCOUNT_NOT_ALLOWED";
