...
@JsonDeserialize(
    builder = GetListOfUsersRequest.Builder.class
)
public final class GetListOfUsersRequest {
  ...
  private GetListOfUsersRequest(Optional<Integer> page, Optional<Integer> size,
  ...
  private boolean equalTo(GetListOfUsersRequest other) {
  ...
  public static final class Builder {
    ...
    public Builder from(GetListOfUsersRequest other) {
      page(other.getPage());
      size(other.getSize());
    ...
    public GetListOfUsersRequest build() {
      return new GetListOfUsersRequest(page, size, sortBy, additionalProperties);
    }
  }
}
