...
public final class ExecuteTradeTransaction implements ITransactionType {
  ...
  private final WalletPaymentMethod sourceMethod;
  ...
  public WalletPaymentMethod getSourceMethod() {
    return sourceMethod;
  }
  ...
  public interface SourceMethodStage {
    DestinationMethodStage sourceMethod(@NotNull WalletPaymentMethod sourceMethod);
  }
  ...
  public static final class Builder implements TypeStage, UsdValueStage, AmountStage, DateStage, InitiatorStage, PtiRequestIdStage, PtiScenarioIdStage, SourceMethodStage, DestinationMethodStage, _FinalStage {
    ...
    private WalletPaymentMethod sourceMethod;
    ...
    public DestinationMethodStage sourceMethod(@NotNull WalletPaymentMethod sourceMethod) {
