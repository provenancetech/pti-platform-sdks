...
public final class ExecuteMintTransaction implements ITransactionType, ITransaction {
  ...
  public interface PtiRequestIdStage {
    DestinationStage ptiRequestId(@NotNull String ptiRequestId);
  }
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, PtiRequestIdStage, DestinationStage, DestinationMethodStage, _FinalStage {
    ...
    public DestinationStage ptiRequestId(@NotNull String ptiRequestId) {
