...
package com.pti.sdk.resources.authentication;
...
import com.pti.sdk.resources.authentication.requests.UserTokenRequest;
import com.pti.sdk.types.InvalidRequestError;
import com.pti.sdk.types.UnmanagedError;
import com.pti.sdk.types.UserToken;
  ...
  public UserToken getUserToken(UserTokenRequest request, RequestOptions requestOptions) {
    ...
    try (Response response = client.newCall(okhttpRequest).execute()) {
      ...
      if (response.isSuccessful()) {
        return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), UserToken.class);
      }
