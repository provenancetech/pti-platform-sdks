...
package com.pti.sdk.resources.userassessment.requests;
...
import com.pti.sdk.types.KycRequest;
...
@JsonDeserialize(
    builder = StartUserAssessmentRequest.Builder.class
)
public final class StartUserAssessmentRequest {
  ...
  private final KycRequest body;

  private final Map<String, Object> additionalProperties;

  private StartUserAssessmentRequest(String ptiRequestId, String ptiScenarioId,
      Optional<String> ptiSessionId, Optional<Boolean> ptiDisableWebhook, KycRequest body,
  ...
  private boolean equalTo(StartUserAssessmentRequest other) {
  ...
  public interface PtiRequestIdStage {
    ...
    Builder from(StartUserAssessmentRequest other);
  }
  ...
  public interface BodyStage {
    _FinalStage body(@NotNull KycRequest body);
  }

  public interface _FinalStage {
    StartUserAssessmentRequest build();
