...
@JsonDeserialize(
    builder = ExecutePaymentTransaction.Builder.class
)
public final class ExecutePaymentTransaction implements ITransactionType, ITransaction {
  ...
  private ExecutePaymentTransaction(TransactionTypeEnum type, Optional<String> id,
      ...
      OneOfPaymentMethod sourceMethod, Optional<WalletPaymentMethodWrapper> destinationMethod,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ExecutePaymentTransaction && equalTo((ExecutePaymentTransaction) other);
  }
  ...
  public interface TypeStage {
    ...
    Builder from(ExecutePaymentTransaction other);
  }
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, PtiRequestIdStage, SourceMethodStage, _FinalStage {
    ...
    public ExecutePaymentTransaction build() {
      return new ExecutePaymentTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, date, initiator, ptiMeta, clientMeta, deviceInformation, ptiRequestId, ptiScenarioId, ptiSessionId, ptiDisableWebhook, ptiProviderName, sourceMethod, destinationMethod, additionalProperties);
    }
  }
}
