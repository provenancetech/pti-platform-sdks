...
public final class ExecuteDepositTransaction implements ITransactionType, ITransaction {
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, PtiRequestIdStage, SourceMethodStage, _FinalStage {
    ...
    public ExecuteDepositTransaction build() {
      return new ExecuteDepositTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, useInstantSettlement, date, initiator, ptiMeta, clientMeta, deviceInformation, ptiRequestId, ptiScenarioId, ptiSessionId, ptiDisableWebhook, ptiProviderName, sourceMethod, destinationMethod, additionalProperties);
    }
  }
}
