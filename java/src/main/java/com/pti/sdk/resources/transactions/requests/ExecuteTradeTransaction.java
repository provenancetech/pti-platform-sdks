...
public final class ExecuteTradeTransaction implements ITransactionType, ITransaction {
  ...
  private final WalletPaymentMethodWrapper sourceMethod;
  ...
  private ExecuteTradeTransaction(TransactionTypeEnum type, Optional<String> id,
      ...
      WalletPaymentMethodWrapper sourceMethod, WalletPaymentMethodWrapper destinationMethod,
  ...
  public WalletPaymentMethodWrapper getSourceMethod() {
    return sourceMethod;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ExecuteTradeTransaction && equalTo((ExecuteTradeTransaction) other);
  }
  ...
  public interface TypeStage {
    ...
    Builder from(ExecuteTradeTransaction other);
  }
  ...
  public interface SourceMethodStage {
    DestinationMethodStage sourceMethod(@NotNull WalletPaymentMethodWrapper sourceMethod);
  }
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, PtiRequestIdStage, SourceMethodStage, DestinationMethodStage, _FinalStage {
    ...
    private WalletPaymentMethodWrapper sourceMethod;
    ...
    public DestinationMethodStage sourceMethod(@NotNull WalletPaymentMethodWrapper sourceMethod) {
    ...
    public ExecuteTradeTransaction build() {
      return new ExecuteTradeTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, date, initiator, ptiMeta, clientMeta, deviceInformation, ptiRequestId, ptiScenarioId, ptiSessionId, ptiDisableWebhook, ptiProviderName, sourceMethod, destinationMethod, additionalProperties);
    }
  }
}
