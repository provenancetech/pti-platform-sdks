...
public final class ExecuteWithdrawalTransaction implements ITransactionType, ITransaction {
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, PtiRequestIdStage, DestinationMethodStage, _FinalStage {
    ...
    public ExecuteWithdrawalTransaction build() {
      return new ExecuteWithdrawalTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, useInstantSettlement, date, initiator, ptiMeta, clientMeta, deviceInformation, ptiRequestId, ptiScenarioId, ptiSessionId, ptiDisableWebhook, ptiProviderName, destinationMethod, sourceMethod, additionalProperties);
    }
  }
}
