...
public final class ExecuteWithdrawalTransaction implements ITransactionType, ITransaction {
  ...
  private final Optional<WalletPaymentMethodWrapper> sourceMethod;
  ...
  public Optional<WalletPaymentMethodWrapper> getSourceMethod() {
    return sourceMethod;
  }
  ...
  public interface _FinalStage {
    ...
    _FinalStage sourceMethod(Optional<WalletPaymentMethodWrapper> sourceMethod);

    _FinalStage sourceMethod(WalletPaymentMethodWrapper sourceMethod);
  }
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, PtiRequestIdStage, PtiScenarioIdStage, DestinationMethodStage, _FinalStage {
    ...
    @java.lang.Override
    public _FinalStage sourceMethod(WalletPaymentMethodWrapper sourceMethod) {
    ...
    public _FinalStage sourceMethod(Optional<WalletPaymentMethodWrapper> sourceMethod) {
      this.sourceMethod = sourceMethod;
      return this;
    }
    ...
    public ExecuteWithdrawalTransaction build() {
      return new ExecuteWithdrawalTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, date, initiator, ptiMeta, clientMeta, deviceInformation, ptiRequestId, ptiScenarioId, ptiSessionId, ptiDisableWebhook, ptiProviderName, destinationMethod, sourceMethod, additionalProperties);
    }
  }
}
