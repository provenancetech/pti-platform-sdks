...
import com.pti.sdk.resources.marketplace.requests.SearchClientWalletsRequest;
...
public class MarketplaceClient {
  ...
  public ObjectReferencePage searchClientWallets(SearchClientWalletsRequest request,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      .addPathSegments("wallets");if (request.getPage().isPresent()) {
      ...
      if (request.getSortDirection().isPresent()) {
        httpUrl.addQueryParameter("sortDirection", request.getSortDirection().get());
      }
