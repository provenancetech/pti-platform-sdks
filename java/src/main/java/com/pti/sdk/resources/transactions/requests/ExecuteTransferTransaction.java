...
public final class ExecuteTransferTransaction implements ITransactionType, ITransaction {
  ...
  private final WalletPaymentMethodWrapper sourceTransferMethod;

  private final WalletPaymentMethodWrapper destinationTransferMethod;
  ...
  private ExecuteTransferTransaction(TransactionTypeEnum type, Optional<String> id,
      ...
      WalletPaymentMethodWrapper sourceTransferMethod,
      WalletPaymentMethodWrapper destinationTransferMethod, OneOfUserSubTypes destination,
  ...
  public WalletPaymentMethodWrapper getSourceTransferMethod() {
    return sourceTransferMethod;
  }

  @JsonProperty("destinationTransferMethod")
  public WalletPaymentMethodWrapper getDestinationTransferMethod() {
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.type, this.id, this.transactionGroupId, this.subClientId, this.transactionTotal, this.usdValue, this.amount, this.useInstantSettlement, this.date, this.initiator, this.ptiMeta, this.clientMeta, this.deviceInformation, this.ptiRequestId, this.ptiScenarioId, this.ptiSessionId, this.ptiDisableWebhook, this.ptiProviderName, this.sourceTransferMethod, this.destinationTransferMethod, this.destination, this.destinationClientId);
  }
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, PtiRequestIdStage, SourceTransferMethodStage, DestinationTransferMethodStage, DestinationStage, _FinalStage {
    ...
    private WalletPaymentMethodWrapper sourceTransferMethod;

    private WalletPaymentMethodWrapper destinationTransferMethod;
    ...
    public SourceTransferMethodStage ptiRequestId(@NotNull String ptiRequestId) {
