...
public final class ExecuteSellTransaction implements ITransactionType, ITransaction {
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, PtiRequestIdStage, PtiScenarioIdStage, DestinationMethodStage, _FinalStage {
    ...
    public ExecuteSellTransaction build() {
      return new ExecuteSellTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, date, initiator, ptiMeta, clientMeta, deviceInformation, ptiRequestId, ptiScenarioId, ptiSessionId, ptiDisableWebhook, ptiProviderName, digitalItem, digitalItems, destinationMethod, buyer, feeRecipients, additionalProperties);
    }
  }
}
