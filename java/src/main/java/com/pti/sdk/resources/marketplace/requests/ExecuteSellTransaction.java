...
public final class ExecuteSellTransaction implements ITransactionType, ITransaction {
  ...
  private final Optional<List<DigitalItem>> digitalItems;

  private final OneOfPaymentMethod destinationMethod;

  private final Optional<OneOfUserSubTypes> buyer;

  private final Optional<List<FeeRecipient>> feeRecipients;
  ...
  /**
   * @return One of digitalItem or digitalItems is required
   */
  @JsonProperty("digitalItems")
  public Optional<List<DigitalItem>> getDigitalItems() {
    return digitalItems;
  }

  @JsonProperty("destinationMethod")
  public OneOfPaymentMethod getDestinationMethod() {
    return destinationMethod;
  }

  @JsonProperty("buyer")
  public Optional<OneOfUserSubTypes> getBuyer() {
    return buyer;
  }

  @JsonProperty("feeRecipients")
  public Optional<List<FeeRecipient>> getFeeRecipients() {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ExecuteSellTransaction && equalTo((ExecuteSellTransaction) other);
  }
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.type, this.id, this.transactionGroupId, this.subClientId, this.transactionTotal, this.usdValue, this.amount, this.useInstantSettlement, this.date, this.initiator, this.ptiMeta, this.clientMeta, this.deviceInformation, this.ptiRequestId, this.ptiScenarioId, this.ptiSessionId, this.ptiDisableWebhook, this.ptiProviderName, this.digitalItem, this.digitalItems, this.destinationMethod, this.buyer, this.feeRecipients);
  }
  ...
  public interface DestinationMethodStage {
    _FinalStage destinationMethod(@NotNull OneOfPaymentMethod destinationMethod);
  }
  ...
  public interface _FinalStage {
    ...
    _FinalStage digitalItems(Optional<List<DigitalItem>> digitalItems);

    _FinalStage digitalItems(List<DigitalItem> digitalItems);

    _FinalStage buyer(Optional<OneOfUserSubTypes> buyer);

    _FinalStage buyer(OneOfUserSubTypes buyer);

    _FinalStage feeRecipients(Optional<List<FeeRecipient>> feeRecipients);

    _FinalStage feeRecipients(List<FeeRecipient> feeRecipients);
  }
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, PtiRequestIdStage, DestinationMethodStage, _FinalStage {
    ...
    private OneOfPaymentMethod destinationMethod;

    private Optional<List<FeeRecipient>> feeRecipients = Optional.empty();

    private Optional<OneOfUserSubTypes> buyer = Optional.empty();

    private Optional<List<DigitalItem>> digitalItems = Optional.empty();
    ...
    public Builder from(ExecuteSellTransaction other) {
      ...
      digitalItems(other.getDigitalItems());
      destinationMethod(other.getDestinationMethod());
      buyer(other.getBuyer());
      feeRecipients(other.getFeeRecipients());
      return this;
    }
    ...
    public _FinalStage destinationMethod(@NotNull OneOfPaymentMethod destinationMethod) {
    ...
    public _FinalStage feeRecipients(Optional<List<FeeRecipient>> feeRecipients) {
      this.feeRecipients = feeRecipients;
      return this;
    }

    @java.lang.Override
    public _FinalStage buyer(OneOfUserSubTypes buyer) {
    ...
    public _FinalStage buyer(Optional<OneOfUserSubTypes> buyer) {
      this.buyer = buyer;
      return this;
    }
    ...
    public _FinalStage digitalItems(Optional<List<DigitalItem>> digitalItems) {
      this.digitalItems = digitalItems;
      return this;
    }
    ...
    public ExecuteSellTransaction build() {
      return new ExecuteSellTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, useInstantSettlement, date, initiator, ptiMeta, clientMeta, deviceInformation, ptiRequestId, ptiScenarioId, ptiSessionId, ptiDisableWebhook, ptiProviderName, digitalItem, digitalItems, destinationMethod, buyer, feeRecipients, additionalProperties);
    }
  }
}
