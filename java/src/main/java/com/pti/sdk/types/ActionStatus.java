...
@JsonDeserialize(
    builder = ActionStatus.Builder.class
)
public final class ActionStatus implements IActionStatus {
  ...
  private ActionStatus(Optional<ResourceType> resourceType, Optional<String> requestId,
  ...
  private boolean equalTo(ActionStatus other) {
  ...
  public static final class Builder {
    ...
    public Builder from(ActionStatus other) {
    ...
    public ActionStatus build() {
      return new ActionStatus(resourceType, requestId, clientId, userId, date, additionalProperties);
    }
  }
}
