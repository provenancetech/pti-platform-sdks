...
public final class BuyTransaction implements ITransactionType, ITransaction {
  ...
  private BuyTransaction(TransactionTypeEnum type, Optional<String> id,
      ...
      Optional<DeviceInformation> deviceInformation, Optional<OneOfPaymentMethod> sourceMethod,
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.type, this.id, this.transactionGroupId, this.subClientId, this.transactionTotal, this.usdValue, this.amount, this.useInstantSettlement, this.date, this.initiator, this.ptiMeta, this.clientMeta, this.deviceInformation, this.sourceMethod, this.destinationMethod, this.digitalItem, this.seller);
  }
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, _FinalStage {
    ...
    public BuyTransaction build() {
      return new BuyTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, useInstantSettlement, date, initiator, ptiMeta, clientMeta, deviceInformation, sourceMethod, destinationMethod, digitalItem, seller, additionalProperties);
    }
  }
}
