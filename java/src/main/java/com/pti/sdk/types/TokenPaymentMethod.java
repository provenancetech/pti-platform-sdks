...
@JsonDeserialize(
    builder = TokenPaymentMethod.Builder.class
)
public final class TokenPaymentMethod {
  ...
  private TokenPaymentMethod(Optional<String> billingEmail,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof TokenPaymentMethod && equalTo((TokenPaymentMethod) other);
  }
  ...
  private boolean equalTo(TokenPaymentMethod other) {
  ...
  public static final class Builder {
    ...
    public Builder from(TokenPaymentMethod other) {
    ...
    public TokenPaymentMethod build() {
      return new TokenPaymentMethod(billingEmail, paymentInformation, additionalProperties);
    }
  }
}
