...
public final class WithdrawalTransaction implements ITransactionType, ITransaction {
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, _FinalStage {
    ...
    public WithdrawalTransaction build() {
      return new WithdrawalTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, useInstantSettlement, date, initiator, ptiMeta, clientMeta, deviceInformation, destinationMethod, sourceMethod, additionalProperties);
    }
  }
}
