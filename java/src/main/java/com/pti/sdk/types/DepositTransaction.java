...
public final class DepositTransaction implements ITransactionType, ITransaction {
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.type, this.id, this.transactionGroupId, this.subClientId, this.transactionTotal, this.usdValue, this.amount, this.useInstantSettlement, this.date, this.initiator, this.ptiMeta, this.clientMeta, this.deviceInformation, this.sourceMethod, this.destinationMethod);
  }
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, _FinalStage {
    ...
    public DepositTransaction build() {
      return new DepositTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, useInstantSettlement, date, initiator, ptiMeta, clientMeta, deviceInformation, sourceMethod, destinationMethod, additionalProperties);
    }
  }
}
