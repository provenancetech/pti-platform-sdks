...
@JsonDeserialize(
    builder = NoAssessmentError.Builder.class
)
public final class NoAssessmentError implements IManagedError {
  private final Optional<ErrorType> type;

  private final Optional<Integer> code;

  private final Optional<Map<String, Object>> assessment;

  private final Map<String, Object> additionalProperties;

  private NoAssessmentError(Optional<ErrorType> type, Optional<Integer> code,
      Optional<Map<String, Object>> assessment, Map<String, Object> additionalProperties) {
    this.type = type;
    this.code = code;
  ...
  public Optional<Map<String, Object>> getAssessment() {
    return assessment;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof NoAssessmentError && equalTo((NoAssessmentError) other);
  }
  ...
  private boolean equalTo(NoAssessmentError other) {
  ...
  public static final class Builder {
    ...
    private Optional<Map<String, Object>> assessment = Optional.empty();
    ...
    public Builder from(NoAssessmentError other) {
      type(other.getType());
      code(other.getCode());
    ...
    public Builder assessment(Optional<Map<String, Object>> assessment) {
      this.assessment = assessment;
      return this;
    }
    ...
    public NoAssessmentError build() {
      return new NoAssessmentError(type, code, assessment, additionalProperties);
    }
  }
}
