...
@JsonDeserialize(
    builder = InvalidUserAssessmentError.Builder.class
)
public final class InvalidUserAssessmentError implements IManagedError {
  ...
  private InvalidUserAssessmentError(Optional<ErrorType> type, Optional<Integer> code,
      Map<String, Object> assessment, Map<String, Object> additionalProperties) {
    this.type = type;
    this.code = code;
   ...
   * INVALID_TRANSACTION_TYPE(1016)
   * INVALID_TRANSACTION_STATUS(1017)
   * INVALID_BANK_ACCOUNT_NUMBER(1018)
   ...
   * INVALID_ACH_PROVIDER_CONFIGURATION(2009)
   ...
   * EXCEEDED_ACH_PULL_DEPOSIT_LIMIT(3018)
   * EXCEEDED_ACH_PULL_DEPOSIT_LIMIT(3019)
   * MAXIMUM_ACH_PULL_LIMIT_EXCEEDED(3020)
   * TRANSACTION_CANNOT_BE_CANCELED(3021)
   * BLOCKED_ASSET(3022)
   * MANUAL_BANK_ACCOUNT_NOT_ALLOWED(3023)
   * BANK_ONLY(4000)
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof InvalidUserAssessmentError && equalTo((InvalidUserAssessmentError) other);
  }
  ...
  private boolean equalTo(InvalidUserAssessmentError other) {
    return type.equals(other.type) && code.equals(other.code) && assessment.equals(other.assessment);
  }

  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.type, this.code, this.assessment);
  }
  ...
  public static final class Builder {
    ...
    public Builder from(InvalidUserAssessmentError other) {
      type(other.getType());
      code(other.getCode());
    ...
    public Builder assessment(Map<String, Object> assessment) {
      this.assessment.clear();
      this.assessment.putAll(assessment);
      return this;
    }

    public Builder putAllAssessment(Map<String, Object> assessment) {
      this.assessment.putAll(assessment);
      return this;
    }

    public Builder assessment(String key, Object value) {
      this.assessment.put(key, value);
      return this;
    }

    public InvalidUserAssessmentError build() {
      return new InvalidUserAssessmentError(type, code, assessment, additionalProperties);
    }
  }
}
