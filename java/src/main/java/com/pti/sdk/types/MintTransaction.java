...
public final class MintTransaction implements ITransactionType, ITransaction {
  ...
  private MintTransaction(TransactionTypeEnum type, Optional<String> id,
      ...
      Optional<DeviceInformation> deviceInformation, Optional<OneOfUserSubTypes> destination,
  ...
  public static final class Builder implements TypeStage, AmountStage, DateStage, InitiatorStage, _FinalStage {
    ...
    public MintTransaction build() {
      return new MintTransaction(type, id, transactionGroupId, subClientId, transactionTotal, usdValue, amount, useInstantSettlement, date, initiator, ptiMeta, clientMeta, deviceInformation, destination, destinationMethod, additionalProperties);
    }
  }
}
